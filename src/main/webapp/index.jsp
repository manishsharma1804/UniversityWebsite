  ...
  <body>
    <section class="header">
      ...
      <div class="text-box">
        ...
        <p>
          ABC University, Ranchi has been established and incorporated by
          Jharkhand State Legislature <br />through its official Gazette and
          recognized as per section 2(f) of UGC Act 1956.
        </p>
    ...
    <section class="news_section">
      <h1>News & Notices</h1>
      <p>
        All Undergraduate and Postgraduate Programs are affiliated to <br />ABC
        University, Ranchi
      </p>
                    ...
                    <li>
                      ...
                      <p>
                        <a href="#"
                          ...
                          elit. Ut elit tellus...<img src="img/new.gif"
                        /></a>
                      </p>
                      <hr />
                    </li>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-6">
            <div class="cardd">
              ...
              <p>
                ...
                education and prior to postgraduate education. It typically
                includes all postsecondary programs up to the level of a
                bachelor's degree. BE in the case of our college.
              </p>
          ...
          <div class="col-12 col-md-6 col-lg-6">
            <div class="cardd">
              ...
              <p>
                ...
                academic or professional degrees, academic or professional
                certificates, academic or professional diplomas, or other
                qualifications for which a first or bachelor's degree generally
                is required, and it is normally considered to be part of higher
                education.
              </p>
          ...
          <div class="col-12 col-md-6 col-lg-6">
            <div class="cardd">
              ...
              <p>
                PhD is short for Doctor of Philosophy. This is an academic or
                professional degree that, in most countries, qualifies the
                degree holder to teach their chosen subject at university level
                or to work in a specialized position in their chosen field.
              </p>
              <a href="#" class="btn1 red-btn">EXPLORE</a>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <div class="cardd">
              ...
              <p>
                This is a full time course offered by the Department of
                Management Technology with avision of expansion and mobilization
                of facilities for offering good quality management education and
                research in the country. To make sure a holistic management
                education and to assist the graduates develop into modern
                leaders of the future, the Institute provides possibilities
                outdoor the lecture rooms as well.
              </p>
              <a href="#" class="btn1 red-btn">EXPLORE</a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4 col-lg-4 facilities-a">
            ...
            <h3>Computer Lab</h3>
            <p>
              The College has high tech computer resource room with more than 50
              computers.
            </p>
            <br />
          ...
          <div class="col-12 col-md-4 col-lg-4 facilities-a">
            ...
            <p>
              The College has well maintained playgrounds for indoor and outdoor
              activities.
            </p>
            <br />
            <a class="btn1 red-btn" href="#">EXPLORE</a>
          ...
          <div class="col-12 col-md-4 col-lg-4 facilities-a">
            ...
            <p>
              The College has its medical room in case of emergency/first-aid
              requirement
            </p>
            <br />
            <a class="btn1 red-btn" href="#">EXPLORE</a>
          ...
          <div class="col-12 col-md-4 col-lg-4 facilities-a">
            ...
            <p>
              The College has well established research centre where faculty and
              students work on the research issues related to society and
              teaching learning.
            </p>
            <br />
            <a class="btn1 red-btn" href="#">EXPLORE</a>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-6">
            <div class="testimonials-a">
              ...
              <div>
                <p>
                  Yes, it is an amazing life in that campus but i could only
                  enjoy 1 year as later pandemic happened. We have all courses
                  text book as well as other books in our library. Our college
                  is always clean the food in canteen is hygienic too. The area
                  is totally safe and it is 5-7 min walking from the station &
                  college can handle the emergenices too.
                </p>
                <h3>Manish Sharma</h3>
          ...
          <div class="col-12 col-md-6 col-lg-6">
            <div class="testimonials-a">
              ...
              <div>
                <p>
                  Yes My college has necessary infrastructure and facilities. We
                  have many fans, lights, blackboard, smart board in the
                  classroom. There 3 basketball grounds, one football ground.
                  badminton area, chess room, 3 canteen, library and much more.
                </p>
                <h3>Ayush Anand</h3>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
