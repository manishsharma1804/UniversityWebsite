...
<jsp:include page="sideNavAdmin.jsp"></jsp:include>
	...
	<section class="searchstd">
    	<div class="add-student">
    		<h3 style="text-align: center">View/Search Student</h3>
    		<form class="form" action="">			
    			<div class="search">
    				<input type="text" class="input" required="required" placeholder="Enter Student ID to search" name= "searchfield">
    			...
    			<div class="container-fluid">
    				...
    				<div class="input-field">
						<input type="Submit" class="submit" value="Edit Details">
					</div>
				</div>
    		</form>
    	</div>
